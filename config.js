...
const config = {
  ...
  siteUrl: 'https://shroom-website.herokuapp.com',
  ...
  // Bot Owner
  ownerId: "904964094493331486",

  // DB Connection Url from mongodb
  dbConnection: "mongodb+srv://guardian:ASDFasdf1234@cluster0.i86ba.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
  ...
  permLevels: [
    ...
    // Updated to utilize the Teams type from the Application, pulls a list of "Owners" from it.
    {
      ...
      check: (message) => {
        ...
        return owner.id === "904964094493331486";
      }
    }
  ],
